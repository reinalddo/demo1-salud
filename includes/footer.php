	...
	<div class="container">
		<div class="row">
            <div class="col-md-4 mb-4">
                ...
                <p class="mt-3 mb-1"><?php echo $clinic_address; ?></p>
                <p class="mb-0">Tel: <a href="tel:+<?php echo $clinic_phone; ?>" class="text-decoration-none text-light"><?php echo $clinic_phone_display; ?></a></p>
            </div>
