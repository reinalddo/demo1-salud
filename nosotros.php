        ...
        <div class="container">
            <div class="row align-items-center gy-4">
                <div class="col-lg-6">
                    ...
                    <p>Desde nuestros inicios hemos priorizado la excelencia clínica y la cercanía con los pacientes. Contamos con un equipo multidisciplinario con amplia experiencia en atención primaria y especializada.</p>
                    <p>Nuestra misión es brindar servicios de salud con calidad, calidez y tecnología, promoviendo el bienestar y la prevención en todas las etapas de la vida.</p>
                </div>
                <div class="col-lg-6">
                    <img src="https://images.unsplash.com/photo-1526256262350-7da7584cf5eb?auto=format&fit=crop&w=900&q=80" alt="Doctores trabajando" class="img-fluid rounded" style="width:100%; object-fit:cover;">
                </div>
            </div>
        </div>
    </section>
